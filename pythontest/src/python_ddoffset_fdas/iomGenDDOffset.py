...
from importScadeType import XscadeReader
...
def main(argv):
    try:
#        sys.argv = [sys.argv[0],'-m','DMHTopLevel','-r','E:/python_test/python_ddoffset/Behaviour','-o','E:/python_test/python_ddoffset/']
    ...
    from genAds2ScadeSim import genDDMap
