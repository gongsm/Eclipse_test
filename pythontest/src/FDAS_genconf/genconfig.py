...
def main():
    ...
    endian          = '--xxendian'
    steps           = 'XBV'
    sys.argv = [sys.argv[0],'--steps','XBV','--bigendian','--indd','F:/workspace/pythontest/src/FDAS_genconf/FDASIOM.inddmap.xml','--outdd', 'F:/workspace/pythontest/src/FDAS_genconf/FDASIOM.outddmap.xml','-o','F:/workspace/pythontest/src/FDAS_genconf','--app','FDASIOM','F:/workspace/pythontest/src/FDAS_genconf/FDASIOM.xlsx']
