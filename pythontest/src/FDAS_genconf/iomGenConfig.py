...
def main():
    ...
    endian          = '--xxendian'
    steps           = 'XBV'
    sys.argv = [sys.argv[0],'--steps','XBV','--bigendian','--indd','E:/FDAS_genconf/FDASIOM.inddmap.xml','--outdd', 'E:/FDAS_genconf/FDASIOM.outddmap.xml','-o','E:/FDAS_genconf','--app','FDASIOM','E:/FDAS_genconf/FDASIOM.xlsx']
