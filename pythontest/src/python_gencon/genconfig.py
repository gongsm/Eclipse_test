...
def main():
    ...
    endian          = '--xxendian'
    steps           = 'XBV'
    sys.argv = [sys.argv[0],'--steps','XB','--bigendian','--indd','F:/workspace/pythontest/src/python_gencon/test.inddmap.xml','--outdd', 'F:/workspace/pythontest/src/python_gencon/test.outddmap.xml','-o','F:/workspace/pythontest/src/python_gencon','--app','test','F:/workspace/pythontest/src/python_gencon/test.xlsx']
