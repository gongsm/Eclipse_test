...
#<namelist model="INTERNAL_PARAMS">
#    <parameter offset="4"   size="4" elements="1" type="bool" name="InternalParam.FadecLIC.FADEC_L_CHA_Local_Channel_in_Control"/>
#    <parameter offset="8"   size="4" elements="1" type="int"  name="InternalParam.FadecLIC.FADEC_L_CHA_Local_Channel_in_Control_Status"/>
#    <parameter offset="12"  size="4" elements="1" type="bool" name="InternalParam.FadecLIC.FADEC_L_CHB_Local_Channel_in_Control"/>
#    <parameter offset="16"  size="4" elements="1" type="int"  name="InternalParam.FadecLIC.FADEC_L_CHB_Local_Channel_in_Control_Status"/>	
#    <parameter offset="20"  size="4" elements="1" type="bool" name="InternalParam.FadecLIC.FADEC_R_CHB_Local_Channel_in_Control"/>
#    <parameter offset="24"  size="4" elements="1" type="int"  name="InternalParam.FadecLIC.FADEC_R_CHB_Local_Channel_in_Control_Status"/>
#	<parameter offset="28"  size="4" elements="1" type="bool" name="InternalParam.FadecLIC.FADEC_R_CHB_Local_Channel_in_Control"/>
#    <parameter offset="32"  size="4" elements="1" type="int"  name="InternalParam.FadecLIC.FADEC_R_CHB_Local_Channel_in_Control_Status"/>
#</namelist>    
